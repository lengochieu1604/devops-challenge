...
|  | **System - OOM (Out of Memory)** | Check for OOM Killer Events: `dmesg | grep -i "oom"` | System running out of available memory | Optimize NGINX settings, limit process memory usage, enable OOM killer | Prevents system crashes and performance degradation |
